...
public class Login extends AppCompatActivity {
    ...
    public static final String urlx = "http://192.168.1.100:8080/Buy_Sell";
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            if(successlogin.equals(true)){
                                ...
                                Toast.makeText(getApplicationContext(), "You have logged in user " + userid, Toast.LENGTH_SHORT).show();
